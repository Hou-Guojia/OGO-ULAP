# Code for Underwater image restoration using oblique gradient operator and light attenuation prior.
...
3. Usages:<br>
	(1) Put the images into the "/images/test" directory.<br>
	(2) Please run “Demo.m” file to generate the result in "/images/test_result" directory.<br>
